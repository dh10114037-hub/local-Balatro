...
export const JOKERS: JokerDefinition[] = [
  ...
  {
    id: 'blind_storyteller',
    name: '盲注说书人',
    rarity: 'uncommon',
    archetypes: ['general'],
    triggerTiming: ['on_play'],
    triggerText: '出牌结算时触发',
    conditionText: '根据本盲注出牌序号',
    price: 5,
    description: '本盲注第几次出牌，就获得对应的 +2 倍率。',
    effects: [{ type: 'played_hands_add_mult', amountPerHand: 2 }]
  },
  {
    id: 'discard_banner',
    name: '弃牌旗帜',
    ...
    conditionText: '仍有弃牌次数',
    price: 4,
    description: '每剩余 1 次弃牌，出牌时 +25 筹码。',
    effects: [{ type: 'remaining_discards_add_chips', amountPerDiscard: 25 }]
  },
  {
    id: 'empty_peak',
    name: '空峰',
    ...
    triggerTiming: ['on_play'],
    triggerText: '出牌结算时触发',
    conditionText: '没有剩余弃牌',
    price: 5,
    description: '没有剩余弃牌时 +15 倍率。',
    effects: [{ type: 'no_discards_add_mult', amount: 15 }]
  },
  {
    id: 'frugal_clown',
    name: '节俭小丑',
    ...
    triggerTiming: ['on_play'],
    triggerText: '出牌结算时触发',
    conditionText: '资金不超过 $3',
    price: 3,
    description: '资金不超过 $3 时 +12 倍率。',
    effects: [{ type: 'money_at_most_add_mult', maxMoney: 3, amount: 12 }]
  },
  {
    id: 'bull_bank',
    name: '硬币公牛',
    ...
    conditionText: '根据当前资金',
    price: 6,
    description: '每拥有 $1，出牌时 +5 筹码，最多 +100。',
    effects: [{ type: 'money_add_chips', amount: 5, divisor: 1, max: 100 }]
  },
  {
    id: 'bonus_collector',
    name: '奖励收藏家',
    rarity: 'common',
    archetypes: ['enhancement'],
    triggerTiming: ['scored_card'],
    triggerText: '计分牌结算时触发',
    conditionText: '奖励牌计分',
    price: 4,
    description: '每张计分奖励牌额外 +30 筹码。',
    effects: [{ type: 'scored_enhancement_add_chips', enhancement: 'bonus', amount: 30 }]
  },
  {
    id: 'mult_collector',
    name: '倍率收藏家',
    ...
    conditionText: '倍率牌计分',
    price: 4,
    description: '每张计分倍率牌额外 +5 倍率。',
    effects: [{ type: 'scored_enhancement_add_mult', enhancement: 'mult', amount: 5 }]
  },
  {
    id: 'wild_signal',
    name: '万能信号',
    rarity: 'uncommon',
    archetypes: ['enhancement', 'flush'],
    triggerTiming: ['scored_card'],
    triggerText: '计分牌结算时触发',
    conditionText: '万能牌计分',
    price: 5,
    description: '每张计分万能牌 +6 倍率。',
    effects: [{ type: 'scored_enhancement_add_mult', enhancement: 'wild', amount: 6 }]
  },
  {
    id: 'stone_stack',
    name: '石堆',
    ...
    conditionText: '石头牌计分',
    price: 4,
    description: '每张计分石头牌额外 +35 筹码。',
    effects: [{ type: 'scored_enhancement_add_chips', enhancement: 'stone', amount: 35 }]
  },
  {
    id: 'steel_engine',
    name: '钢铁引擎',
    ...
    conditionText: '钢铁牌留在手牌中',
    price: 7,
    description: '每张留在手牌中的钢铁牌额外使倍率 x1.25。',
    effects: [{ type: 'held_enhancement_multiply_mult', enhancement: 'steel', factor: 1.25 }]
  },
  {
    id: 'five_card_stamp',
    name: '五张印章',
    ...
    triggerTiming: ['on_play'],
    triggerText: '出牌结算时触发',
    conditionText: '本手正好选择 5 张牌',
    price: 4,
    description: '正好选择 5 张牌出牌时 +70 筹码。',
    effects: [{ type: 'selected_cards_exactly_add_chips', cards: 5, amount: 70 }]
  },
  {
    id: 'solo_stamp',
    name: '独行印章',
    ...
    triggerTiming: ['on_play'],
    triggerText: '出牌结算时触发',
    conditionText: '本手正好选择 1 张牌',
    price: 5,
    description: '正好选择 1 张牌出牌时 +16 倍率。',
    effects: [{ type: 'selected_cards_exactly_add_mult', cards: 1, amount: 16 }]
  },
  {
    id: 'face_free_bus',
    name: '无脸巴士',
    rarity: 'rare',
    archetypes: ['growth', 'face'],
    triggerTiming: ['on_play'],
    triggerText: '出牌结算时触发，并在出牌后成长或重置',
    conditionText: '没有 J/Q/K 计分',
    price: 7,
    description: '每次没有人头牌计分就成长；之后每级 +1 倍率。若有人头牌计分则重置。',
    effects: [{ type: 'level_add_mult', amountPerLevel: 1 }],
    growthOnNoScoredFace: { amount: 1, resetOnFace: true }
  },
  {
    id: 'green_counter',
    name: '绿色计数器',
    ...
    conditionText: '每次出牌',
    price: 5,
    description: '每次出牌都会成长；之后每级 +1 倍率。',
    effects: [{ type: 'level_add_mult', amountPerLevel: 1 }],
    growthOnEveryHand: { amount: 1 }
  },
  {
    id: 'glass_accountant',
    name: '玻璃会计',
    ...
    conditionText: '玻璃牌计分',
    price: 6,
    description: '每张计分玻璃牌额外 +8 倍率。',
    effects: [{ type: 'scored_enhancement_add_mult', enhancement: 'glass', amount: 8 }]
  },
  {
    id: 'gold_counter',
    name: '黄金柜台',
    ...
    conditionText: '黄金牌计分',
    price: 5,
    description: '每张计分黄金牌额外 +40 筹码。',
    effects: [{ type: 'scored_enhancement_add_chips', enhancement: 'gold', amount: 40 }]
  }
];
